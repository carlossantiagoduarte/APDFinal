...
<head>
    ...
    <title>Panel administrativo | CodeVision</title>
...
<body>
    ...
    <!-- Botón "Ver información del evento" alineado a la derecha y debajo de la tabla -->
    <div class="admin-box" style="text-align: right; margin-top: 10px;">
        <button class="btn-admin" onclick="window.location.href='info-evento.html'" style="margin-right: 20px;">
