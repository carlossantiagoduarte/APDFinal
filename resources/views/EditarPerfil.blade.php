...
<body>
    ...
    <div class="profile-container">
        ...
        <div class="profile-info">
            ...
            @if (session('success'))
                <div
                    style="background-color:#d4edda; color:#155724; padding:10px; border-radius:5px; margin-top: 10px;">
                    {{ session('success') }}
                </div>
            @endif
            ...
            @if ($errors->any())
                <div
                    style="background-color:#f8d7da; color:#721c24; padding:10px; border-radius:5px; margin-top: 10px;">
                    <ul>
        ...
        <div class="profile-form-box">
            ...
            <form class="profile-form" action="{{ route('profile.update') }}" method="POST">
                ...
                <p style="font-size: 0.9em; color: #666; margin-bottom: 10px;">Deja las contraseñas vacías si no
                    quieres cambiarlas.</p>
