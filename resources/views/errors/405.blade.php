...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('styles/error405.css') }}">
...
<body>
    ...
    <div class="error-container">
        ...
        <h2 class="error-title">Método No Permitido</h2>
        <p style="margin-bottom: 30px; color: #777;">
            El método HTTP utilizado no está permitido para esta página. Verifica la URL o intenta con otro método.
        </p>
